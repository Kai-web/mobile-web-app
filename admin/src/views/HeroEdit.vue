                ...
                <el-tab-pane label="课程信息" name="basic">
                    ...
                    <el-form-item label="缩略图">
                        <el-upload class="avatar-uploader" :action="$http.defaults.baseURL + '/upload'"
                            ...
                            <img style="width:15rem" v-if="model.avatar" :src="model.avatar" class="avatar">
                    ...
                    <el-form-item label="课程亮点">
                        <el-input autosize type="textarea" v-model="model.usageTips"></el-input>
                    </el-form-item>
                    <el-form-item label="适用对象">
                        <el-input autosize type="textarea" v-model="model.battleTips"></el-input>
                    </el-form-item>
                    <el-form-item label="课程内容">
                        <el-input autosize type="textarea" v-model="model.teamTips"></el-input>
                    </el-form-item>
                </el-tab-pane>
                <el-tab-pane label="同类课程" name="skills">
                    <el-button style="margin-bottom:1rem" type="primary"  @click="model.skills.push({})"> <i class="el-icon-plus"></i> 添加课程</el-button>
                    <el-row type="flex" style="flex-wrap:wrap">
                        <el-col :md="12" v-for="(item, i) in model.skills" :key="i">
                            ...
                            <img style="width:15rem" v-if="item.icon" :src="item.icon" class="avatar">
                            <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                        </el-upload>
                            </el-form-item>
                            <el-form-item label="课程描述">
                                <el-input autosize v-model="item.description" type="textarea"></el-input>
                            </el-form-item>
                            <el-form-item label="小提示">
                                <el-input autosize v-model="item.tips" type="textarea"></el-input>
                            </el-form-item>
